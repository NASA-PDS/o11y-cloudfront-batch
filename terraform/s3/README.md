...
- `module.s3_bucket` — S3 bucket via [pdc-tf-modules](https://github.com/NASA-PDS/pdc-tf-modules) with SSE, public-access blocks disabled (enforced at the account level), and an SSL-only deny bucket policy
